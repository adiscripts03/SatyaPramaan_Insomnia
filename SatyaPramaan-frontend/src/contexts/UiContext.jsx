...
const HI_TRANSLATIONS = {
  ...
  "AI Insight (Advisory)": "AI अंतर्दृष्टि (सलाहकारी)",
  "AI Key Findings": "AI मुख्य निष्कर्ष",
  "No AI summary available": "AI सारांश उपलब्ध नहीं है",
  "AI output is advisory only.": "AI आउटपुट केवल सलाहकारी है।",
  Confidence: "विश्वसनीयता",
  Pages: "पेज",
  "Detected Text Replacements": "पहचाने गए टेक्स्ट बदलाव",
  "additional changes not shown": "अतिरिक्त बदलाव नहीं दिखाए गए",
  "Detected Visual Marks": "पहचाने गए दृश्य चिह्न",
  "Random line marks detected": "यादृच्छिक रेखा चिह्न पाए गए",
  "Pen scribble marks detected": "पेन स्क्रिबल चिह्न पाए गए",
